...
class ClientAdmin(admin.ModelAdmin):
    list_display = ('first_name','reg_no','last_name', 'email', 'phone_number','visit_count', 'last_examination_date','registered_by','created_at') 
...
class ExaminationAdmin(admin.ModelAdmin):
    list_display = ('client', 'examination_date', 'examined_by', 'state', 'booked_for_sales')
